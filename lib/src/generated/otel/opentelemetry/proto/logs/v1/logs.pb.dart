...
class LogRecord extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LogRecord', package: const $pb.PackageName(_omitMessageNames ? '' : 'opentelemetry.proto.logs.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4.AnyValue>(5, _omitFieldNames ? '' : 'body', subBuilder: $4.AnyValue.create)
    ..pc<$4.KeyValue>(6, _omitFieldNames ? '' : 'attributes', $pb.PbFieldType.PM, subBuilder: $4.KeyValue.create)
  ...
  @$pb.TagNumber(2)
  set severityNumber(SeverityNumber v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(5)
  $4.AnyValue get body => $_getN(3);
  @$pb.TagNumber(5)
  set body($4.AnyValue v) { $_setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasBody() => $_has(3);
  @$pb.TagNumber(5)
  void clearBody() => $_clearField(5);
  @$pb.TagNumber(5)
  $4.AnyValue ensureBody() => $_ensure(3);

  /// Additional attributes that describe the specific event occurrence. [Optional].
  /// Attribute keys MUST be unique (it is not allowed to have more than one
  /// attribute with the same key).
  @$pb.TagNumber(6)
  $pb.PbList<$4.KeyValue> get attributes => $_getList(4);
