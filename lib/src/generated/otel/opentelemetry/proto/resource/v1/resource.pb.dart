...
class Resource extends $pb.GeneratedMessage {
  factory Resource({
    ...
    $core.Iterable<$4.EntityRef>? entityRefs,
  }) {
    final $result = create();
    if (attributes != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Resource', package: const $pb.PackageName(_omitMessageNames ? '' : 'opentelemetry.proto.resource.v1'), createEmptyInstance: create)
    ...
    ..pc<$4.EntityRef>(3, _omitFieldNames ? '' : 'entityRefs', $pb.PbFieldType.PM, subBuilder: $4.EntityRef.create)
  ...
  ///  Status: [Development]
  @$pb.TagNumber(3)
  $pb.PbList<$4.EntityRef> get entityRefs => $_getList(2);
}
